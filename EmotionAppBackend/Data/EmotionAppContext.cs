...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        optionsBuilder.UseMySql(
            "server=118.31.55.155;user=root;password=lyq;database=EmotionApp",
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Permission>(entity =>
        {
            ...
            entity.ToTable(
                "permissions",
                tb => tb.HasComment("权限表，存储系统权限信息，支持权限层级关系")
            );
        ...
        modelBuilder.Entity<Role>(entity =>
        {
            ...
            entity.Property(e => e.RoleId).HasComment("角色唯一标识").HasColumnName("role_id");
            entity
                .Property(e => e.CreatedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasComment("角色创建时间")
            ...
            entity
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable(
                            "role_permissions",
                            tb => tb.HasComment("角色权限关联表，存储角色和权限的多对多关系")
                        );
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.UserId).HasComment("用户唯一标识").HasColumnName("user_id");
            entity
                .Property(e => e.CreatedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasComment("用户创建时间")
            ...
            entity
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable(
                            "user_roles",
                            tb => tb.HasComment("用户角色关联表，存储用户和角色的多对多关系")
                        );
